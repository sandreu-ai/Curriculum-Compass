...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/about`, lastModified: siteLastUpdated, changeFrequency: 'monthly', priority: 0.65 },
    { url: `${SITE_URL}/contact`, lastModified: siteLastUpdated, changeFrequency: 'monthly', priority: 0.55 },
    { url: `${SITE_URL}/editorial-policy`, lastModified: siteLastUpdated, changeFrequency: 'monthly', priority: 0.6 },
