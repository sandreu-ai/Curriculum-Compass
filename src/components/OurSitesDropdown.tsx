...
export default function OurSitesDropdown() {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen((o) => !o)}
        className="font-body text-sm font-medium text-gray-600 hover:text-forest transition-colors duration-200 flex items-center gap-1"
      >
        Our Sites
        <motion.svg
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-8 w-72 bg-white rounded-2xl border border-cream-darker shadow-lg overflow-hidden z-50"
          >
            <div className="p-2">
              <Link
                href="/"
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-body text-xs text-gray-500 mt-0.5">
                    Real homeschool encouragement · Blog · Shop
                  </p>
                </div>
              </a>
              <a
